...
class InvoicesControllerTest < ActionController::TestCase
  setup do
    ...
    @retainage_unexpected_line.update_attributes(:labor_retainage => 100000)
  ...
  test "should start in expected states" do
...
=begin  
  ...
  # Select Template
  test "should get select template in state new" do
    get :select_template, :id => @invoice.to_param
    assert_response :success
  end
  
  test "should get select_template in state missing_task" do
    get :select_template, :id => @missing_task_invoice.to_param
    assert_redirected_to start_invoice_path(assigns(:invoice))
  end
  
  test "should get select_template in state payments_unbalanced" do
    get :select_template, :id => @payments_unbalanced_invoice.to_param
    assert_redirected_to start_invoice_path(assigns(:invoice))
  end
  
  test "should get select_template in state retainage_expected" do
    get :select_template, :id => @retainage_expected_invoice.to_param
    assert_redirected_to set_amounts_invoice_path(assigns(:invoice))
  end
  
  test "should get select_template in state retainage_unexpected" do
    get :select_template, :id => @retainage_unexpected_invoice.to_param
    assert_redirected_to set_amounts_invoice_path(assigns(:invoice))
  end
  
  test "should get select_template in state costs_specified" do
    get :select_template, :id => @costs_specified_invoice.to_param
    assert_response :success
  end
  
  test "should get select_template in state complete" do
  ...
  test "should get finished in state missing_task" do
    get :finished, :id => @missing_task_invoice.to_param
    assert_redirected_to start_invoice_path(assigns(:invoice))
  end
  
  test "should get finished in state payments_unbalanced" do
    get :finished, :id => @payments_unbalanced_invoice.to_param
    assert_redirected_to start_invoice_path(assigns(:invoice))
  end
  
  test "should get finished in state retainage_expected" do
    get :finished, :id => @retainage_expected_invoice.to_param
    assert_redirected_to set_amounts_invoice_path(assigns(:invoice))
  end
  
  test "should get finished in state retainage_unexpected" do
    get :finished, :id => @retainage_unexpected_invoice.to_param
    assert_redirected_to set_amounts_invoice_path(assigns(:invoice))
  end
  
  test "should get finished in state costs_specified" do
    get :finished, :id => @costs_specified_invoice.to_param
    assert_redirected_to select_template_invoice_path(assigns(:invoice))
  end
  
  test "should get finished in state complete" do
    get :finished, :id => @complete_invoice.to_param
    assert_response :success
  end
  
  # Accept Costs
  test "should accept costs in state retainage_expected" do
  ...
  test "should accept costs in state retainage_unexpected" do
  ...
  test "should create invoice" do
    ...
    assert_redirected_to project_invoice_path(@project1, assigns(:invoice))
  end
  ...
  test "should update new invoice" do
  ...
  test "should update missing_task invoice" do
    put :update, :project_id => @project1.to_param, :id => @missing_task_invoice.to_param, :invoice => {
      :date => Date::today, :name => 'foo'
    }
    assert_redirected_to set_amounts_invoice_path(assigns(:invoice))
  end
  
  test "should update payments_unbalanced invoice" do
  ...
  test "should update retainage_expected invoice" do
  ...
  test "should update retainage_unexpected invoice" do
  ...
  test "should update costs_specified invoice" do
    put :update, :project_id => @project1.to_param, :id => @costs_specified_invoice.to_param, :invoice => {
      :template => 'template_AIA_G703'
    }
    assert_redirected_to complete_invoice_path(assigns(:invoice))
  end
  
  
  test "fail to update invoice" do
    put :update, :project_id => @project1.to_param, :id => @invoice.to_param, :invoice => {
      :project_id => nil
    }
    assert_redirected_to project_invoice_path(@project1, assigns(:invoice))
  end
