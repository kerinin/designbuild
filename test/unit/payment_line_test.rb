...
class PaymentLineTest < ActiveSupport::TestCase
  ...
  context "An Payment Line" do
    setup do
      ...
      @obj = Factory :payment_line, :payment => @payment, :component => @component, :labor_paid => 0, :labor_retained => 0, :material_paid => 0, :material_retained => 0
    ...
    should "require a component" do
      assert_raise ActiveRecord::RecordInvalid do
        Factory :payment_line, :component => nil
      end
    end
    
    should_eventually "default to outstanding paid" do
      @obj.set_defaults
      
      assert_equal @component.labor_invoiced - @p_line.labor_paid, @obj.labor_paid
      assert_equal @component.material_invoiced - @p_line.material_paid, @obj.material_paid
      assert_equal @obj.labor_paid + @obj.material_paid, @obj.paid
    end
    
    should_eventually "default to outstanding retained" do
      @obj.set_defaults
      
      assert_equal @component.labor_retainage - @p_line.labor_retained, @obj.labor_retained
      assert_equal @component.material_retainage - @p_line.material_retained, @obj.material_retained
