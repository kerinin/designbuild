class LaborCostsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @labor_cost.save
        format.html { redirect_to(@labor_cost, :notice => 'Labor cost was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @labor_cost.update_attributes(params[:labor_cost])
        format.html { redirect_to(@labor_cost, :notice => 'Labor cost was successfully updated.') }
        format.xml  { head :ok }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to(labor_costs_url) }
      format.xml  { head :ok }
    end
  end
end
