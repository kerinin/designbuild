class LaborCostLinesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @labor_cost_line.save
        format.html { redirect_to(@labor_cost_line, :notice => 'Labor cost line was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @labor_cost_line.update_attributes(params[:labor_cost_line])
        format.html { redirect_to(@labor_cost_line, :notice => 'Labor cost line was successfully updated.') }
        format.xml  { head :ok }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to(labor_cost_lines_url) }
      format.xml  { head :ok }
    end
  end
end
